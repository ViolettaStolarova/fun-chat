...
export const SEARCH_ICON = '🔍︎';

export const enum MessageStatusesIcons {
  SENT = '📩',
  DELIVERED = '📨',
  READED = '✓',
}
...
export const enum DialogueNotifications {
  SELECT_USER_NOTIFICATION = 'Select the user to start the dialog...',
  WRITE_FIRST_MESSAGE_NOTIFICATION = 'Write your first message...',
}

export const DELETE_ICON = '🗑️';

export const SEND_ICON_STRING_SVG_ELEMENT = `<svg viewBox="0 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
